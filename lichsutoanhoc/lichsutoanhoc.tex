...
\begin{multicols}{2}
	...
	\vskip 0.1cm
	Có vẻ như, không phải là $\sqrt{2}$  mà là  $\sqrt{5}$ lần đầu tiên tiết lộ sự tồn tại của các đại lượng không thông ước. Tính chất vô tỷ của tỷ lệ này, trên thực tế, là hệ quả của lập luận được trình bày trên Hình $3$, trong đó tỷ lệ vàng được hiển thị lặp đi lặp lại nhiều lần:
	\begin{align*}
	...
	\vskip 0.1cm
	\PIbox{\hspace*{30pt}``\texttt{Let no one ignorant of \hspace*{30pt}geometry enter here.}"}
	\vskip 0.1cm
	...
	\begin{figure}[H]
		...
		\centering
		\captionsetup{labelformat= empty, justification=centering}
		\begin{tikzpicture}[scale=0.9, lichsutoanhoc, node font=\small]
			\draw  (0.,0.)-- (3.,3.);
			\draw  (3.,3.)-- (0.,6.);
			\draw  (0.,6.)-- (-3.,3.);
			\draw  (-3.,3.)-- (0.,0.);
