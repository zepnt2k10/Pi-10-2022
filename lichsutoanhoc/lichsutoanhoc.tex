...
\begin{multicols}{2}
	...
	\vskip 0.1cm
	\PIbox{\textbf{Bài tập.} Sử dụng chứng minh $\sqrt{2}$  là số vô tỷ (xem [$10$]), hãy chứng minh $\sqrt{3}$  là số vô tỷ, hay đường chéo của hình lập phương không thông ước với cạnh của nó. Tương tự, chứng minh $\sqrt{5}$ là số vô tỷ.}
	\vskip 0.1cm
	...
	\vskip 0.1cm
	\PIbox{``Let no one ignorant of geometry enter here."}
	\vskip 0.1cm
	...
	\begin{figure}[H]
		...
		\vspace*{-10pt}
	\end{figure}
%	Đỉnh trên cùng: Lửa-Tứ diện đều; Đỉnh trái: Không khí-Bát diện đều; Đỉnh dưới: Nước-Khối 20 mặt đều; Đỉnh phải: Đất-Lập phương.
%	Cạnh trên, trái:  Khô.
%	Cạnh dưới trái: Lạnh
%	Cạnh dưới phải:  ẩm ướt; Cạnh trên: nóng.
